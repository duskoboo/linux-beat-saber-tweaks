...
The problem is that those fonts have overlapping unicode declarations, so.. BSML doesn't really know how to handle that **(This behavior was changed, I was only able to replicate it on version 1.40.8 and below, but this is still the recommended version, as of when I'm writing this)**

## The fix
It's rather simple actually.. you need to merge those fonts!
...
Either way, make sure the merged font is named `segoeui.ttf`, as that's what BeatSaberPlus uses.
